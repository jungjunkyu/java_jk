...
public class LottoEx {
	...
	public static void main(String[] args) {
		...
		//랜덤으로 로또번호 6개와 보너스번호 1개를 생성
		//7개짜리 배열에 로또번호를 생성하고, 앞에 6개는 로또 번호, 마지막 1개는 보너스
		int lotto[] = new int[7];
		//7개짜리 배열에 로또번호를 생성
	 ...
	 * 매개변수 : 일치하는 개수, 보너스번호와 일치여부 => int count, boolean checkBonus
	 * 리턴타입 : void
	 * 메서드명 : printResult
	 * 
	 */
	public static void printResult(int count, boolean checkBonus) {
		switch(count){
			case 6:
				System.out.println("Winner fo the lotto!");
				break;
			case 5:
				if(checkBonus) {
