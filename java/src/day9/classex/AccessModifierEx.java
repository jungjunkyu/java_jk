...
public class AccessModifierEx {
	...
	public static void main(String[] args) {
		...
		//AccessModifier 클래스와 ㅠ 클래스는 같은 패키지에 있는 클래스
		//num3은 접근제어자가 public. 같은 패키지이든 아니든 상관없음.
		a.num3 = 10;
		b.num3 = 20;
		
		//num2는 접근제어자가 디폴트(생략됨).
		//다른패키지에 있는 B클래스의 객체에 있는 num2는 접근이 안됨.
		a.num2 = 10;
		//b.num2 = 20;
		
		//num1은 접근제어자가 private.
		//같은 패키지이든 아니든 다른 클래스에서 접근 할 수 없음.
		//a.num1 =10;
		a.setNum1(10);
		//getter를 통해 값을 가져옴		
