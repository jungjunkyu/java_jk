...
public class ClassInheriranceEx {
	...
	public static void main(String[] args) {
		 ...
		 * -스마트폰 : 클래스
		 * -카메라 : 멤버변수
		 * 부모 클래스에게 상속받은 기능들을 사용 할 수 있다.
		 * -접근 제어자가 public, protected인 경우
		 * -디폴트는 같은 패키지인 경우는 가능하나 다른 패키지면 불가능
		 */
...
class Phone{
	private String num = "010-1212-3434";//전화번호
	...
	//public Phone(){}//생성자가 하나도 없으면 컴파일 할 때 기본 생성자가 자동으로 추가
}
