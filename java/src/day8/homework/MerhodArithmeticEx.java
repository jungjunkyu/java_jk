...
public class MerhodArithmeticEx {

	public static void main(String[] args) {
		//두 정수와 산술 연산자를 입력받아 산술연산결과를 출력하는 코드를 작성하시오
		//메서드 이용
	...
	/** 두 정수와 산술 연산자가 주어지면 산술 연산겨로가를 알려주는 메서드
	 * 매개변수 : 두 정수와 산술연산자 => int num1, char operator, int num2
